...
The workflows rely on the `requirements.txt <https://github.com/tsutterley/Spire-GNSS/blob/main/requirements.txt>`_ and `test requirements.txt <https://github.com/tsutterley/Spire-GNSS/blob/main/requirements-dev.txt>`_ files to install the required dependencies.
